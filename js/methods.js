...
const methods = [
  ...
  {
    title: "1.3. Метод «Мозговой штурм»",
    description:
      "Методика стимулирует творческое мышление и коллективное обсуждение идей.",
    example:
      "Соберите как можно больше идей по теме «Экологические проблемы города».",
  ...
  },
  {
    title: "1.3. Метод «Мозговой штурм»",
    description:
      "Методика стимулирует творческое мышление и коллективное обсуждение идей. Методика стимулирует творческое мышление и коллективное обсуждение идей. Методика стимулирует творческое мышление и коллективное обсуждение идей. Методика стимулирует творческое мышление и коллективное обсуждение идей. Методика стимулирует творческое мышление и коллективное обсуждение идей. Методика стимулирует творческое мышление и коллективное обсуждение идей.",
    example:
      "Соберите как можно больше идей по теме «Экологические проблемы города».",
    source: "https://example.com",
  },
